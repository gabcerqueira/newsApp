...
export type DropdownVariantTypes = "info" | "warn" | "error" | "success";
...
const DropdownAlertComponent = ({
  ...
  return (
    <Container
      dismissInterval={dropdownAlertConstants.DROPDOWN_CLOSE_INTERVAL}
      onDismissPressDisabled={
        dropdownAlertConstants.DROPDOWN_TAP_TO_CLOSE_ENABLED
      }
